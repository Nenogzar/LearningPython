...
print(f"From 0 to 9: {(number_9/moves)*100:.2f}%")
print(f"From 10 to 19: {(number_19/moves)*100:.2f}%")
print(f"From 20 to 29: {(number_29/moves)*100:.2f}%")
print(f"From 30 to 39: {(number_39/moves)*100:.2f}%")
print(f"From 40 to 50: {(number_50/moves)*100:.2f}%")
print(f"Invalid numbers: {(number_invalid/moves)*100:.2f}%")
